...
public class MK_DemoControl : MonoBehaviour 
{
	...
	private void ManageRoom0()
	{
		...
		mkGlow.Samples = Mathf.RoundToInt(GUI.HorizontalSlider(new Rect(1500, 850, 400, 100), mkGlow.Samples, 4, 12));
		GUI.Label(new Rect(1500, 900, 300, 50), "Blur Iterations", r2bStyle);
		mkGlow.BlurIterations = Mathf.RoundToInt(GUI.HorizontalSlider(new Rect(1500, 950, 400, 100), mkGlow.BlurIterations, 0, 10));
